...
def update_test_payload_xml(dep, ret):
    """
    Read XML file and modify the values and create new xml
    """
...
def update_json(elem):
    """
    Read Json file and remove keys and create new json file again
    """
...
def read_jmeter(file_name):
    """
    Read | sep file and convert itinto csv format
    """
    custom_headers = ''
    chunk_size = 10000
